...
export const adminBrokers: AdminBroker[] = [
  ...
  },
  {
    ...
    status: "Ativo",
    receita: 184_200,
    avatar: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=128&q=80",
  },
  {
    id: "U-003",
    nome: "Aldemar Souza",
    ...
    status: "Ativo",
    receita: 142_800,
    avatar: "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=128&q=80",
  },
  {
    id: "U-004",
  ...
  },
  {
    ...
    status: "Inativo",
    receita: 0,
    avatar: "https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?w=128&q=80",
  },
  {
    id: "U-010",
    nome: "Marcos Iglesias",
    creci: "RS-44820",
...
export const cobrancas: Cobranca[] = [
  ...
  },
  {
    ...
    faturadoEm: "22/04",
    vendaId: "VD-117",
    divergencia: { esperado: 14_100, cobrado: 14_600 },
  },
  {
    id: "CB-2038",
    corretor: "Ramon Capone",
    origem: "SaaS",
    valor: 120,
    vencimento: "01/05",
    status: "Pago",
  ...
  },
  {
    ...
    criadoEm: "05/04",
    faturadoEm: "11/04",
    divergencia: { esperado: 4_200, cobrado: 5_600 },
  },
  {
    id: "CB-2030",
    corretor: "Alessandra Freixo",
...
export const corretorRisco: Record<
  string,
  { nivel: "baixo" | "medio" | "alto"; pctAtraso: number; totalAberto: number }
> = {
...
export type StatusOperacionalCobranca =
  | "Em cobrança"
  | "Em negociação"
...
export type ConciliacaoSplit = {
  nome: string;
  valor: number;
  tipo: "Captador" | "Parceiro" | "Fee Ubroker";
};
export type ConciliacaoInteracaoTipo =
  | "Ligação"
  | "WhatsApp"
  | "E-mail"
  | "Mensagem"
  | "Negociação";
export type ConciliacaoInteracao = {
  tipo: ConciliacaoInteracaoTipo;
  obs: string;
  data: string;
  autor: string;
};
export type ConciliacaoAuditoria = {
  data: string;
  autor: string;
  acao: string;
...
export function agruparPorCorretor(lista: Conciliacao[]): AgrupadoCorretor[] {
  ...
  for (const c of lista) {
    ...
    const sla = calcularSLA(c);
    if (sla.atrasado || c.status === "Pendente")
      g.totalAtraso += Math.max(c.esperado - c.recebido, 0);
  }
...
const CONTRATO_PADRAO: ContratoAplicado = {
  versao: "v1.2",
  data: "01/01/2026",
  regras: "6% comissão · 60/30/10 captador/parceiro/fee Ubroker",
};

const _conciliacoesBase: Omit<
  Conciliacao,
  "slaDias" | "contrato" | "historicoCorretor" | "responsavel" | "previsaoPagamento" | "comprovante"
>[] = [
  {
    id: "CC-441",
    venda: "VD-118",
  ...
  },
  {
    ...
    interacoes: [
      {
        tipo: "Ligação",
        obs: "Corretora confirmou diferença por taxa de TED. Vai complementar.",
        data: "27/04 16:20",
        autor: "Superadmin",
      },
    ],
    auditoria: [
      ...
      { data: "20/04 09:30", autor: "Sistema", acao: "Fatura enviada" },
      {
        data: "27/04 15:10",
        autor: "Superadmin",
        acao: "Recebimento parcial registrado",
        valorAnterior: 0,
        valorNovo: 18_900,
      },
    ],
  },
  {
    ...
    interacoes: [
      {
        tipo: "Mensagem",
        obs: "Enviado lembrete via WhatsApp.",
        data: "22/04 10:14",
        autor: "Superadmin",
      },
  ...
  },
  {
    ...
    recebido: 9_400,
    status: "Confirmada",
    imovel: "Apartamento Charitas",
    vgv: 1_560_000,
    tipo: "Parceria",
    comissaoPct: 6,
    comissaoTotal: 93_600,
    splits: [
  ...
  },
  {
    ...
    interacoes: [
      {
        tipo: "Negociação",
        obs: "Corretor pagou a mais. Investigar origem.",
        data: "24/04 18:00",
        autor: "Superadmin",
      },
    ],
    auditoria: [
      ...
      { data: "10/04 10:00", autor: "Sistema", acao: "Fatura enviada" },
      {
        data: "24/04 17:30",
        autor: "Superadmin",
        acao: "Recebimento divergente registrado",
        valorAnterior: 0,
        valorNovo: 14_800,
      },
    ],
  },
  {
    ...
    recebido: 0,
    status: "Pendente",
    imovel: "Loft Centro Histórico",
    vgv: 720_000,
    tipo: "Lead Ubroker",
    comissaoPct: 6,
    comissaoTotal: 43_200,
    splits: [
    ...
    interacoes: [
      {
        tipo: "Mensagem",
        obs: "Enviado e-mail formal de cobrança.",
        data: "10/04 09:00",
        autor: "Superadmin",
      },
  ...
  },
  {
    ...
    recebido: 11_200,
    status: "Parcial",
    imovel: "Cobertura Vista Mar · Icaraí",
    vgv: 3_060_000,
    tipo: "Parceria",
    comissaoPct: 6,
    comissaoTotal: 183_600,
    splits: [
    ...
    interacoes: [
      {
        tipo: "Negociação",
        obs: "Pagou 60%, complemento previsto para 02/05.",
        data: "26/04 11:00",
        autor: "Superadmin",
      },
    ],
  ...
  },
  {
    ...
    recebido: 6_200,
    status: "Confirmada",
    imovel: "Casa Maricá · Itaipuaçu",
    vgv: 1_032_000,
    tipo: "Parceria",
    comissaoPct: 6,
    comissaoTotal: 61_920,
    splits: [
...
const _govOverrides: Record<string, Partial<Conciliacao>> = {
  "CC-441": {
    responsavel: { tipo: "admin", nome: "Superadmin" },
    slaDias: 3,
    contrato: CONTRATO_PADRAO,
    historicoCorretor: {
      pagamentosAtrasoPct: 8,
      tempoMedioPagamentoDias: 9,
      totalPagoHub: 184_300,
      totalAberto: 0,
    },
    comprovante: {
      nome: "comprovante-cc441.pdf",
      tipo: "PDF",
      referencia: "PIX · BB",
      enviadoEm: "26/04 11:42",
    },
  },
  "CC-440": {
    responsavel: { tipo: "operador", nome: "Operador Cobranças" },
    slaDias: 3,
    previsaoPagamento: "30/04",
    contrato: CONTRATO_PADRAO,
    historicoCorretor: {
      pagamentosAtrasoPct: 18,
      tempoMedioPagamentoDias: 12,
      totalPagoHub: 96_400,
      totalAberto: 1_800,
    },
  },
  "CC-439": {
    ...
    contrato: CONTRATO_PADRAO,
    historicoCorretor: {
      pagamentosAtrasoPct: 42,
      tempoMedioPagamentoDias: 22,
      totalPagoHub: 38_900,
      totalAberto: 3_420,
    },
  },
  "CC-438": {
    ...
    contrato: CONTRATO_PADRAO,
    historicoCorretor: {
      pagamentosAtrasoPct: 5,
      tempoMedioPagamentoDias: 8,
      totalPagoHub: 142_700,
      totalAberto: 0,
    },
  },
  "CC-437": {
    responsavel: { tipo: "operador", nome: "Operador Financeiro" },
    slaDias: 3,
    previsaoPagamento: "29/04",
    contrato: CONTRATO_PADRAO,
    historicoCorretor: {
      pagamentosAtrasoPct: 22,
      tempoMedioPagamentoDias: 14,
      totalPagoHub: 71_200,
      totalAberto: 0,
    },
  },
  "CC-436": {
    ...
    contrato: CONTRATO_PADRAO,
    historicoCorretor: {
      pagamentosAtrasoPct: 55,
      tempoMedioPagamentoDias: 28,
      totalPagoHub: 12_400,
      totalAberto: 4_800,
    },
  },
  "CC-435": {
    ...
    contrato: CONTRATO_PADRAO,
    historicoCorretor: {
      pagamentosAtrasoPct: 28,
      tempoMedioPagamentoDias: 16,
      totalPagoHub: 88_700,
      totalAberto: 7_200,
    },
  },
  "CC-434": {
    ...
    contrato: CONTRATO_PADRAO,
    historicoCorretor: {
      pagamentosAtrasoPct: 12,
      tempoMedioPagamentoDias: 11,
      totalPagoHub: 64_300,
      totalAberto: 0,
    },
  },
...
export const conciliacoes: Conciliacao[] = _conciliacoesBase.map(
  (c) =>
    ({
      slaDias: 3,
      contrato: CONTRATO_PADRAO,
      historicoCorretor: {
        pagamentosAtrasoPct: 0,
        tempoMedioPagamentoDias: 0,
        totalPagoHub: 0,
        totalAberto: 0,
      },
      ...c,
...
export const disputas: Disputa[] = [
  {
    id: "D-022",
    partes: ["Aldemar Souza", "Pedro Verissimo"],
    motivo: "Divergência sobre captação do lead L-1041 (Camila Andrade).",
    status: "Em análise",
    data: "26/04",
  },
  {
    id: "D-021",
    partes: ["Ramon Capone", "Joana Maciel"],
    motivo: "Comissão de parceria não repassada após fechamento do Studio São Francisco.",
    status: "Aberta",
    data: "27/04",
  },
  {
    id: "D-020",
    partes: ["Denise Molinaro", "Beatriz Lemos"],
    motivo: "Cliente atribuído a duas indicações em paralelo.",
    status: "Resolvida",
    data: "20/04",
  },
];
...
export const bypassAlertas: BypassAlerta[] = [
  {
    id: "BP-008",
    corretor: "Rafael Couto",
    lead: "L-1024 · Igor Mascarenhas",
    indicio:
      "Lead recebido pela Ubroker, fechado fora do sistema (CRECI registrado em outra imobiliária).",
    risco: "Alto",
  },
  {
    id: "BP-007",
    corretor: "Tiago Sá",
    lead: "L-1037 · Marcelo Pinheiro",
    indicio: "Conversa migrada do Inbox Ubroker para WhatsApp pessoal sem registro de proposta.",
    risco: "Médio",
  },
  {
    id: "BP-006",
    corretor: "Carla Souza",
    lead: "L-1029 · Dr. Carlos Andrade",
    indicio: "Imóvel removido do marketplace 48h antes da venda registrada externamente.",
    risco: "Alto",
  },
];
...
export const auditLogs: AuditLog[] = [
  {
    id: "L-9912",
    ator: "Alessandra Freixo",
    acao: "registrou venda",
    alvo: "VD-118 · Cobertura Linear",
    tipo: "Venda",
    data: "Hoje 10:24",
    critico: true,
  },
  {
    id: "L-9911",
    ator: "Ramon Capone",
    acao: "criou parceria com",
    alvo: "Aldemar Souza · IM-006",
    tipo: "Parceria",
    data: "Hoje 09:18",
  },
  {
    id: "L-9910",
    ator: "Denise Molinaro",
    acao: "assinou contrato",
    alvo: "VD-117 · Casa Camboinhas",
    tipo: "Contrato",
    data: "Ontem 18:42",
    critico: true,
  },
  {
    ...
    ator: "Superadmin",
    acao: "alterou regra",
    alvo: "Fee Ubroker (parceria) 10% → 12%",
    tipo: "Regra",
    data: "Ontem 14:02",
    critico: true,
  },
  {
    ...
    alvo: "Rafael Couto · suspeita de bypass",
    tipo: "Bloqueio",
    data: "Ontem 11:30",
    critico: true,
  },
  {
    id: "L-9907",
    ator: "Sistema",
    acao: "confirmou pagamento",
    alvo: "CB-2035 · Marcos Iglesias",
    tipo: "Pagamento",
    data: "Ontem 09:00",
  },
  {
    id: "L-9906",
    ator: "Pedro Verissimo",
    acao: "registrou venda",
    alvo: "VD-115 · Apt 2 suítes Charitas",
    tipo: "Venda",
    data: "2 dias atrás",
  },
  {
...
export const iaLogs: IALog[] = [
  ...
  {
    id: "IA-3399",
    lead: "Vanessa Ribeiro",
    canal: "Instagram",
    score: 64,
    resultado: "Em qualificação",
    data: "Hoje 02:44",
  },
  {
    id: "IA-3398",
    lead: "Marcelo Pinheiro",
    canal: "Instagram",
    score: 41,
...
export const adminParcerias = [
  {
    id: "P-2201",
    imovel: "Cobertura Linear · Jardim Icaraí",
    captador: "Alessandra Freixo",
    parceiro: "Ramon Capone",
  ...
  },
  {
    ...
    captador: "Denise Molinaro",
    parceiro: "Aldemar Souza",
    status: "Finalizada" as const,
    comissao: 186_300,
  },
  {
    id: "P-2199",
    imovel: "Apartamento Charitas",
    captador: "Pedro Verissimo",
    parceiro: "Beatriz Lemos",
  ...
  },
  {
    id: "P-2197",
    imovel: "Loft Centro Histórico",
    captador: "Carla Fontes",
    parceiro: "Marcos Iglesias",
    status: "Cancelada" as const,
    comissao: 0,
  },
  {
    id: "P-2196",
    imovel: "Sala Comercial Centro Empresarial",
    captador: "Beatriz Lemos",
    parceiro: "Joana Maciel",
    status: "Ativa" as const,
    comissao: 49_200,
  },
];
...
export const despesasMock: Despesa[] = [
  {
    ...
    descricao: "Infraestrutura cloud (AWS)",
    tipo: "Fixo",
    valor: 4_800,
    status: "Pago",
  ...
  },
  {
    ...
    data: "18/04",
    categoria: "Marketing",
    descricao: "Produção de conteúdo institucional",
    tipo: "Variável",
    valor: 2_900,
    status: "A pagar",
    responsavel: "Marketing",
    observacao: "Vence em 28/04",
  },
  {
    id: "DP-1007",
    data: "20/04",
    categoria: "Tecnologia",
    descricao: "SaaS — CRM e ferramentas",
    tipo: "Fixo",
    valor: 1_850,
    status: "Pago",
    responsavel: "TI",
  },
  {
    ...
    data: "22/04",
    categoria: "Operacional",
    descricao: "Logística e deslocamentos",
    tipo: "Variável",
    valor: 1_240,
    status: "A pagar",
  ...
  },
  {
    ...
    data: "26/04",
    categoria: "Outros",
    descricao: "Treinamento equipe comercial",
    tipo: "Variável",
    valor: 3_100,
    status: "A pagar",
    responsavel: "RH",
    observacao: "Workshop com consultoria externa",
  },
];
  ...
  baixaPerformance: [
    {
      ...
      nome: "Rafael Couto",
      avatar: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=128&q=80",
      motivo: "Bloqueado · 32d sem login",
      severidade: "red",
    },
    {
      id: "U-009",
    ...
    },
    {
      ...
      nome: "Joana Maciel",
      avatar: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=128&q=80",
      motivo: "Conversão 6% · poucos leads",
      severidade: "amber",
    },
  ] as CorretorBaixa[],
};
...
export const redeIndicacoes: RedeIndicacaoItem[] = [
  ...
  // N1 — indicados diretos por Ramon
  {
    ...
    nome: "Joana Maciel",
    nivel: 1,
    indicador: "Ramon Capone",
    indicadorId: "RI-000",
    indicados: 2,
    status: "Inativo",
    produto: "Combo",
    mrr: 240,
    receitaAcumulada: 2_880,
    receitaPaga: 2_400,
    receitaPendente: 480,
    dataEntrada: "12/03/2025",
    crescimentoPct: -18,
  },
  {
    id: "RI-002",
  ...
  },
  {
    ...
    produto: "Inbox",
    mrr: 120,
    receitaAcumulada: 360,
    receitaPaga: 240,
    receitaPendente: 120,
    dataEntrada: "02/10/2025",
    crescimentoPct: 0,
  },
  // N2 (indicados por N1)
  {
    ...
    nome: "Lúcia Mota",
    nivel: 2,
    indicador: "Joana Maciel",
    indicadorId: "RI-001",
    indicados: 1,
    status: "Ativo",
    produto: "IA",
    mrr: 120,
    receitaAcumulada: 1_080,
    receitaPaga: 960,
    receitaPendente: 120,
    dataEntrada: "18/05/2025",
    crescimentoPct: 12,
  },
  {
    id: "RI-006",
    ...
    produto: "Inbox",
    mrr: 120,
    receitaAcumulada: 720,
    receitaPaga: 720,
    receitaPendente: 0,
    dataEntrada: "22/06/2025",
    crescimentoPct: -25,
  },
  {
    id: "RI-007",
    nome: "Carla Souza",
    nivel: 2,
    indicador: "Pedro Verissimo",
    indicadorId: "RI-002",
    indicados: 2,
    status: "Ativo",
    produto: "Combo",
    mrr: 120,
    receitaAcumulada: 1_320,
    receitaPaga: 1_200,
    receitaPendente: 120,
  ...
  },
  {
    ...
    produto: "Combo",
    mrr: 240,
    receitaAcumulada: 2_640,
    receitaPaga: 2_400,
    receitaPendente: 240,
    dataEntrada: "14/03/2025",
    crescimentoPct: 18,
  },
  {
    id: "RI-009",
  ...
  },
  {
    ...
    nome: "Felipe Andrade",
    nivel: 3,
    indicador: "Carla Souza",
    indicadorId: "RI-007",
    indicados: 0,
    status: "Ativo",
    produto: "Inbox",
    mrr: 120,
    receitaAcumulada: 480,
    receitaPaga: 360,
    receitaPendente: 120,
    dataEntrada: "20/08/2025",
    crescimentoPct: 9,
  },
  {
    id: "RI-012",
    nome: "Marina Lopes",
    nivel: 3,
    indicador: "Lúcia Mota",
    indicadorId: "RI-005",
    indicados: 0,
    status: "Ativo",
    produto: "Combo",
    mrr: 120,
    receitaAcumulada: 600,
    receitaPaga: 480,
    receitaPendente: 120,
...
export const redeAlertas: RedeAlerta[] = [
  {
    id: "AL-1",
    severidade: "critico",
    titulo: "Joana Maciel parou de gerar receita",
    descricao: "Sem novos indicados há 38 dias · MRR caiu 18%.",
    corretor: "Joana Maciel",
  },
  {
    id: "AL-2",
    severidade: "atencao",
    titulo: "Queda de 12% na rede em outubro",
    descricao: "MRR consolidado abaixo do mês anterior.",
  },
  {
    id: "AL-3",
    severidade: "atencao",
    titulo: "3 indicados em churn neste mês",
    descricao: "Pedro Inácio, Otávio Pires e 1 indicado N2 deixaram a rede.",
  },
  {
    id: "AL-4",
    severidade: "critico",
    titulo: "Redução da receita recorrente",
    descricao: "Receita recorrente total recuou R$ 180/mês vs período anterior.",
  },
];
