    ...
    <div className="max-w-3xl space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Regras globais de negócio da plataforma.
        </p>
      </div>

      <Card title="Comissão e fees">
        <Field
          label="Comissão padrão sobre venda"
          sub="Aplicada quando o corretor não define comissão própria."
        >
        ...
        <Field
          label="Fee Ubroker — lead próprio"
          sub="Cobrado quando o lead foi gerado pela plataforma."
        >
