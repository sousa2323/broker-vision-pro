    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-2xl bg-navy p-6 text-navy-foreground">
          ...
          <div className="mt-2 text-xs text-warm">
            Você já cobriu <span className="font-semibold">80%</span> do seu plano com indicações.
          </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <div className="rounded-2xl border border-border bg-card p-6">
          ...
          <div className="mt-4 grid grid-cols-3 gap-2">
            {[
              { n: kpis.leadsNovos, l: "Leads novos", c: "Últimos 7 dias" },
...
function KpiMeta() {
  const meta = 3;
  const vendidos = kpis.vendidosMes;
  ...
  return (
    <div className="rounded-2xl border border-border bg-card/60 p-5">
      ...
      <div className="mt-2 text-xs text-muted-foreground">Falta 1 venda para atingir sua meta</div>
    </div>
  );
}
